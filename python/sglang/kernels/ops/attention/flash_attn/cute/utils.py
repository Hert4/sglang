...
def fmax(
    ...
    *,
    ...
    # Pick the nvvm.fmax signature by what the installed cutlass DSL actually
    # accepts (old API wants the result type first), not by CUDA version:
    # cu12.9 images ship a DSL whose fmax already uses the new signature.
