...
class ModelRunner:
    ...
    def init_cuda_graphs(self, capture_decode_cuda_graph: bool = True):
        capture = ModelRunner.capture_cuda_graphs(
    ...
    def init_decode_cuda_graph(self):
        ...
        capture = ModelRunner.capture_decode_graph(model_runner=self)
    ...
    def init_prefill_cuda_graph(self, force_for_draft_worker: bool = False):
        ...
        self.prefill_cuda_graph_runner = ModelRunner.capture_prefill_graph(
            model_runner=self,
